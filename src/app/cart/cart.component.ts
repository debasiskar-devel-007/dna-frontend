  ...
  ngOnInit() {
    if (this.activatedRoute.snapshot.params._id != null && this.activatedRoute.snapshot.params._id != undefined) {
      this.activatedRoute.data.forEach((response: any) => {
        ...
        if (this.cartDetails != null && this.cartDetails[0].price == null) {
          this.cartDetails[0].price = price;
...
export class loginModal {
  ...
  loginuser() {
    ...
    window.open('https://dna-backend.influxiq.com/login/' + this.dta[0].tempid)
